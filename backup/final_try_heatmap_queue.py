...
hist_size = 8    # Number of histogram bins
...
def car_detection(img):
    ...
    if is_video == False:
        ...
        curr_heat = add_heat(heat,box_list)
        heatmaps.append(curr_heat)
        final_heat = sum(heatmaps)

        final_heat = apply_threshold(final_heat,9)
        final_heat =np.clip(final_heat,0,255)
