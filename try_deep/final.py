...
from deep   import deep_init,deep_predict
...
def car_detection(img):
    ...
    for xb in range(nxsteps):
        for yb in range(nysteps):
            ...
            #print("XXXXXXXXXXXXXXX", subimg.shape)
            #print("XXXXXXXXXXXXXXX", subimg[0],subimg[1])
            ...
            #print("PREDICT.......", subimg[0,0,0])  
            test_prediction = deep_predict(subimg)
            #print("deep_predict out:", test_prediction)
            if test_prediction == 1:   # car!
    ...
    #is_video=False #XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    if is_video == False:
